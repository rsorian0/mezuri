      ...
      <div className="container">
        <div className="exclusive-grid">
          <div>
            ...
            <a href="#agendar" className="btn-white btn-lg fade-up" style={{ marginTop: '2rem', padding: '0.7rem 1.6rem', display: 'inline-flex' }} onClick={scrollToAgendar}>Quero agendar um diagnóstico</a>
          </div>
          <div className="rules">
            ...
            <div className="rule fade-up"><div className="rule-check" /><p className="rule-text"><strong>Proposta personalizada.</strong> O valor é definido depois do diagnóstico.</p></div>
            <div className="rule fade-up"><div className="rule-check" /><p className="rule-text"><strong>Apenas para arquitetura.</strong> Não atendemos outros segmentos.</p></div>
            <div className="rule fade-up"><div className="rule-check" /><p className="rule-text"><strong>Assinatura contínua.</strong> O escritório usa todo mês com suporte ativo.</p></div>
          </div>
        </div>
      </div>
    </section>
